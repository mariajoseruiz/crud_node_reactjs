...
//hooks, enganchar componente con funciones de react
const CompShowBlogs=()=>{
                            ...
                            {blogs.map((blog)=>(
                                <tr key={blog.id}>
                                    ...
                                    <td>
                                        ...
                                        <button className='btn btn-danger' onClick={()=>deleteBlog(blog.id)}><i className="fa-solid fa-trash-can"></i></button>
                                    </td>
                                </tr>
                            ))}
                        </tbody>
